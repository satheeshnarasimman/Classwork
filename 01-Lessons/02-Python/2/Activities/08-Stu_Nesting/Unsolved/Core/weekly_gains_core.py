...
aapl_entry= new_records["AAPL"]
mu_entry= new_records["MU"]
amd_entry= new_records["AMD"]
twtr_entry= new_records["TWTR"]


# @TODO: Choice 1: Add a new round of entries to the 'historical_stock_data' dictionary
historical_stock_data["AAPL"].append(aapl_entry)
historical_stock_data["MU"].append(mu_entry)
historical_stock_data["AMD"].append(amd_entry)
historical_stock_data["TWTR"].append(twtr_entry)
